...
//Each joint has been given an angle of 60 degrees. As we move away from n=1. each angle gets multiplied by 2
...
for(angleIncrementer=90;angleIncrementer<=120;angleIncrementer++){
...
for(angleIncrementer=120;angleIncrementer>=60;angleIncrementer--){
  motor_1.write(angleIncrementer);
  motor_2.write(angleIncrementer);
  motor_3.write(angleIncrementer);
  delay(10);
...
for(angleIncrementer=60;angleIncrementer<=90;angleIncrementer++){
  motor_1.write(angleIncrementer);
  motor_2.write(angleIncrementer);
  motor_3.write(angleIncrementer);
  delay(10);
...
void C_MOVE(){
  ...
  int angleIncrementer=90;
  for(angleIncrementer=90;angleIncrementer<=120;angleIncrementer++){
    motor_1.write(angleIncrementer+5);
    motor_2.write(angleIncrementer);
    motor_3.write(angleIncrementer);
    delay(10);
  }
  
  for(angleIncrementer=120;angleIncrementer>=90;angleIncrementer--){
    motor_1.write(angleIncrementer-5);
    motor_2.write(angleIncrementer);
    motor_3.write(angleIncrementer);
    delay(10);
...
void C_MOVE_LEFT(){
  ...
  int angleIncrementer=90;
  for(angleIncrementer=90;angleIncrementer>=60;angleIncrementer--){
    motor_1.write(angleIncrementer+5);
    motor_2.write(angleIncrementer);
    motor_3.write(angleIncrementer);
    delay(10);
